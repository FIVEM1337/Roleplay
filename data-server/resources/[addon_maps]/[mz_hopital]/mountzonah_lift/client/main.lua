...
function Entrance1Tp()
    --ESX.UI.Menu.CloseAll()
        ...
        local heading = GetGameplayCamRelativeHeading()
            ...
            Citizen.Wait(3000)
            SetEntityCoords(PlayerPedId(), Config.Zones.Entrance1.Spawn.x, Config.Zones.Entrance1.Spawn.y, Config.Zones.Entrance1.Spawn.z)
            SetEntityHeading(PlayerPedId(), Config.Zones.Entrance1.Heading)
            TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "demo", 0.2)
...
function Entrance2Tp()
    --ESX.UI.Menu.CloseAll()
        ...
        local heading = GetGameplayCamRelativeHeading()
            ...
            DoScreenFadeOut(1000)
            Citizen.Wait(3000)
            SetEntityCoords(PlayerPedId(), Config.Zones.Entrance2.Spawn.x, Config.Zones.Entrance2.Spawn.y, Config.Zones.Entrance2.Spawn.z)
            SetEntityHeading(PlayerPedId(), Config.Zones.Entrance2.Heading)
            TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "demo", 0.2)
            SetGameplayCamRelativeHeading(heading)
            DoScreenFadeIn(1000)
...
function Entrance3Tp()
    --ESX.UI.Menu.CloseAll()
        ...
        local heading = GetGameplayCamRelativeHeading()
            ...
            DoScreenFadeOut(1000)
            Citizen.Wait(3000)
            SetEntityCoords(PlayerPedId(), Config.Zones.Entrance3.Spawn.x, Config.Zones.Entrance3.Spawn.y, Config.Zones.Entrance3.Spawn.z)
            SetEntityHeading(PlayerPedId(), Config.Zones.Entrance3.Heading)
            TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "demo", 0.2)
            SetGameplayCamRelativeHeading(heading)
            DoScreenFadeIn(1000)
...
function Room1Tp()
    --ESX.UI.Menu.CloseAll()
        ...
        local heading = GetGameplayCamRelativeHeading()
            ...
            DoScreenFadeOut(1000)
            Citizen.Wait(3000)
            SetEntityCoords(PlayerPedId(), Config.Zones.Room1.Spawn.x, Config.Zones.Room1.Spawn.y, Config.Zones.Room1.Spawn.z)
            SetEntityHeading(PlayerPedId(), Config.Zones.Room1.Heading)
            TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "demo", 0.2)
            SetGameplayCamRelativeHeading(heading)
            DoScreenFadeIn(1000)
...
function Room2Tp()
    --ESX.UI.Menu.CloseAll()
        ...
        local heading = GetGameplayCamRelativeHeading()
            ...
            DoScreenFadeOut(1000)
            Citizen.Wait(3000)
            SetEntityCoords(PlayerPedId(), Config.Zones.Room2.Spawn.x, Config.Zones.Room2.Spawn.y, Config.Zones.Room2.Spawn.z)
            SetEntityHeading(PlayerPedId(), Config.Zones.Room2.Heading)
            TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "demo", 0.2)
            SetGameplayCamRelativeHeading(heading)
            DoScreenFadeIn(1000)
...
function Room3Tp()
    --ESX.UI.Menu.CloseAll()
        ...
        local heading = GetGameplayCamRelativeHeading()
            ...
            DoScreenFadeOut(1000)
            Citizen.Wait(3000)
            SetEntityCoords(PlayerPedId(), Config.Zones.Room3.Spawn.x, Config.Zones.Room3.Spawn.y, Config.Zones.Room3.Spawn.z)
            SetEntityHeading(PlayerPedId(), Config.Zones.Room3.Heading)
            TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "demo", 0.2)
            SetGameplayCamRelativeHeading(heading)
            DoScreenFadeIn(1000)
...
function UrgenceParkingTp()
    --ESX.UI.Menu.CloseAll()
        ...
        local heading = GetGameplayCamRelativeHeading()
            ...
            DoScreenFadeOut(1000)
            Citizen.Wait(3000)
            SetEntityCoords(PlayerPedId(), Config.Zones.UrgenceParking.Spawn.x, Config.Zones.UrgenceParking.Spawn.y, Config.Zones.UrgenceParking.Spawn.z)
            SetEntityHeading(PlayerPedId(), Config.Zones.UrgenceParking.Heading)
            TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "demo", 0.2)
            SetGameplayCamRelativeHeading(heading)
            DoScreenFadeIn(1000)
...
function ParkingTp()
    --ESX.UI.Menu.CloseAll()
        ...
        local heading = GetGameplayCamRelativeHeading()
            ...
            DoScreenFadeOut(1000)
            Citizen.Wait(3000)
            SetEntityCoords(PlayerPedId(), Config.Zones.Parking.Spawn.x, Config.Zones.Parking.Spawn.y, Config.Zones.Parking.Spawn.z)
            SetEntityHeading(PlayerPedId(), Config.Zones.Parking.Heading)
            TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "demo", 0.2)
            SetGameplayCamRelativeHeading(heading)
            DoScreenFadeIn(1000)
...
function UrgencePriveTp()
    --ESX.UI.Menu.CloseAll()
        ...
        local heading = GetGameplayCamRelativeHeading()
            ...
            DoScreenFadeOut(1000)
            Citizen.Wait(3000)
            SetEntityCoords(PlayerPedId(), Config.Zones.UrgencePrive.Spawn.x, Config.Zones.UrgencePrive.Spawn.y, Config.Zones.UrgencePrive.Spawn.z)
            SetEntityHeading(PlayerPedId(), Config.Zones.UrgencePrive.Heading)
            TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "demo", 0.2)
            SetGameplayCamRelativeHeading(heading)
            DoScreenFadeIn(1000)
...
function OperationTp()
    --ESX.UI.Menu.CloseAll()
        ...
        local heading = GetGameplayCamRelativeHeading()
            ...
            DoScreenFadeOut(1000)
            Citizen.Wait(3000)
            SetEntityCoords(PlayerPedId(), Config.Zones.Operation.Spawn.x, Config.Zones.Operation.Spawn.y, Config.Zones.Operation.Spawn.z)
            SetEntityHeading(PlayerPedId(), Config.Zones.Operation.Heading)
            TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "demo", 0.2)
            SetGameplayCamRelativeHeading(heading)
            DoScreenFadeIn(1000)
...
function RoomPriveTp()
    --ESX.UI.Menu.CloseAll()
        ...
        local heading = GetGameplayCamRelativeHeading()
            ...
            DoScreenFadeOut(1000)
            Citizen.Wait(3000)
            SetEntityCoords(PlayerPedId(), Config.Zones.RoomPrive.Spawn.x, Config.Zones.RoomPrive.Spawn.y, Config.Zones.RoomPrive.Spawn.z)
            SetEntityHeading(PlayerPedId(), Config.Zones.RoomPrive.Heading)
            TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "demo", 0.2)
            SetGameplayCamRelativeHeading(heading)
            DoScreenFadeIn(1000)
...
--[[function PillboxHeliTp()
    --ESX.UI.Menu.CloseAll()
        ...
        local heading = GetGameplayCamRelativeHeading()
            ...
            DoScreenFadeOut(1000)
            Citizen.Wait(3000)
            SetEntityCoords(PlayerPedId(), Config.Zones.PillboxHeli.Spawn.x, Config.Zones.PillboxHeli.Spawn.y, Config.Zones.PillboxHeli.Spawn.z-1)
            SetEntityHeading(PlayerPedId(), Config.Zones.PillboxHeli.Heading)
            TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 25, "demo", 0.2)
            SetGameplayCamRelativeHeading(heading)
            DoScreenFadeIn(1000)
