Locales['de'] = {
  ...
  ['get_item_menu'] = 'Lager - Item auslagern',
  ['put_item_menu'] = 'Inventar - Item einlagern',
...
-- Death
    ...
    ['you_confiscated'] = 'Du hast ~y~%sx~s~ ~b~%s~s~ konfiziert',
    ['got_confiscated'] = '~y~%sx~s~ ~b~%s~s~ wurden dir konfiziert',
    ['you_confiscated_account'] = 'Du hast ~g~$%s~s~ Schwarzgeld konfiziert',
    ['got_confiscated_account'] = '~g~$%s~s~ Schwarzgeld wurden dir konfiziert',
    ['you_confiscated_weapon'] = 'Du hast ~b~%s~s~ mit ~o~%s~s~ kugeln konfiziert',
    ['got_confiscated_weapon'] = 'Deine ~b~%s~s~ mit ~o~%s~s~ kugeln wurden konfiziert',
    

    ['revive_inprogress'] = 'Du versucht eine Bewustlose Person zu behandeln!',
    ...
    ['not_enough_medikit'] = 'Du hast kein Medikit dabei.',
    ['not_enough_bandage'] = 'Du hast keine Verband dabei.',
...
-- Vehicle Menu
    ...
    ['search_database_error_invalid'] = 'Das Kennzeichen wurde nicht in der Datenbank gefunden',
    ['plate'] = 'Kennzeichen: %s',
