...
AddEventHandler("esx_doorlock:Init",function(...)
...
AddEventHandler("esx_doorlock:Remove",function(door_index)
...
RegisterCommand('doors_create',function(source,args)

  TriggerClientEvent("esx_doorlock:CreateDoors",source)

end,true)



RegisterCommand('doors_remove',function(source,args)

  TriggerClientEvent("esx_doorlock:Remove",source)
...
Doors.SetLocked = function(door_index,lock_state)
  ...
  TriggerClientEvent("esx_doorlock:SetLocked",-1,door_index,lock_state)
...
Doors.MinigameLocked = function(door_index,door_state,item_name)
  ...
  if Config.WarnPoliceOnSuccess then
    ...
    TriggerClientEvent("esx_doorlock:NotifyPolice",-1,door_index)
...
Doors.Init = function(source)
  ...
  TriggerClientEvent("esx_doorlock:Init",source,Config.Doors)
...
Doors.Remove = function(door_index)
  ...
  TriggerClientEvent("esx_doorlock:Removed",-1,door_index)
...
RegisterNetEvent("esx_doorlock:JobLocked")

AddEventHandler("esx_doorlock:JobLocked",Doors.JobLocked)



RegisterNetEvent("esx_doorlock:ItemLocked")

AddEventHandler("esx_doorlock:ItemLocked",Doors.ItemLocked)



RegisterNetEvent("esx_doorlock:HouseLocked")

AddEventHandler("esx_doorlock:HouseLocked",Doors.HouseLocked)



RegisterNetEvent("esx_doorlock:PurchaseKey")

AddEventHandler("esx_doorlock:PurchaseKey",Doors.PurchaseKey)



RegisterNetEvent("esx_doorlock:MinigameLocked")

AddEventHandler("esx_doorlock:MinigameLocked",Doors.MinigameLocked)



RegisterNetEvent("esx_doorlock:MinigameFailed")

AddEventHandler("esx_doorlock:MinigameFailed",Doors.MinigameFailed)



ESX.RegisterServerCallback("esx_doorlock:GetJobs",function(source,callback)
...
RegisterNetEvent("esx_doorlock:Save")

AddEventHandler("esx_doorlock:Save",function(data)
  ...
  TriggerClientEvent("esx_doorlock:Saved",-1,data)
