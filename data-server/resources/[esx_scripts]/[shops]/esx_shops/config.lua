...
Config.Map = {
	...
	{name="Shop",color=2, id=52,scale=0.8, x = 1135.808,  y = -982.281,  z = 45.415},
	{name="Shop",color=2, id=52,scale=0.8, x = -1222.915, y = -906.983,  z = 11.326},
	{name="Shop",color=2, id=52,scale=0.8, x = -1487.553, y = -379.107,  z = 39.163},
	{name="Shop",color=2, id=52,scale=0.8, x = -2968.243, y = 390.910,   z = 14.043},
