...
RegisterNetEvent('esx_playerradialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('esx_playerradialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('esx_playerradialmenu:ToggleProps', ToggleProps)
