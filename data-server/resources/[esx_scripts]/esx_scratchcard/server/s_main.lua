...
ESX.RegisterUsableItem('scratch_ticket', function(source)
  ...
  TriggerClientEvent("esx_scratchcard:isActiveCooldown", source)
end)

RegisterNetEvent("esx_scratchcard:handler", function(returncooldown, cooldown)
  ...
  TriggerClientEvent("esx_scratchcard:startScratchingEmote", _source)
  ...
  for key,priceInfo in pairs(Config.Prices) do
    ...
    if randomNumber > add and randomNumber <= add + chance then
      ...
      TriggerClientEvent("esx_scratchcard:nuiOpenCard", _source, key, price, amount, price_type)
      return price
    end
    add = add + chance
  end
...
RegisterNetEvent("esx_scratchcard:deposit", function(key, price, amount, type)
  ...
  for priceKey,priceInfo in pairs(Config.Prices) do
    ...
    TriggerClientEvent("esx_scratchcard:setCooldown", _source)
    players[tempsrc] = nil
    return
end)