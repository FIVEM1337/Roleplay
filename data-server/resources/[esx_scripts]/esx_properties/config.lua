...
Config.useBlackMoney = false -- unused since the newest update
...
Translation = {
    ['de'] = {
        ...
        ['wallet'] = 'Konto',
        ['credit'] = 'Guthaben:',
        ['black_credit'] = 'Schwarzgeld:',
        ['current_credit'] = 'Dein aktuelles Guthaben beträgt ~b~',
        ['current_blackcredit'] = 'Dein aktuelles Schwarzgeld-Guthaben beträgt ~b~',
        ['money_deposit'] = 'Geld einzahlen',
        ['blackmoney_deposit'] = 'Schwarzgeld einzahlen',
        ['money_withdraw'] = 'Geld abheben',
        ['blackmoney_withdraw'] = 'Schwarzgeld abheben',
        ['currency'] = '$',
    ...
    ['en'] = {
        ...
        ['wallet'] = 'Wallet',
        ['credit'] = 'Wallet:',
        ['black_credit'] = 'Blackmoney Wallet:',
        ['current_credit'] = 'You currently have ~b~',
        ['current_blackcredit'] = 'You currently have ~b~',
        ['money_deposit'] = 'Deposit money',
        ['blackmoney_deposit'] = 'Deposit black money',
        ['money_withdraw'] = 'Withdraw money',
        ['blackmoney_withdraw'] = 'Withdraw black money',
        ['currency'] = '$',
