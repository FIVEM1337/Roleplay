...
-- Weapon Menu --
RegisterNetEvent('esx_personalmenu:Weapon_addAmmoToPedC')
AddEventHandler('esx_personalmenu:Weapon_addAmmoToPedC', function(value, quantity)
...
-- Admin Menu --
RegisterNetEvent('esx_personalmenu:Admin_BringC')
AddEventHandler('esx_personalmenu:Admin_BringC', function(plyCoords)
								...
								if not IsPedSittingInAnyVehicle(closestPed) then
									...
									if ammo > 0 then
										if quantity <= ammo and quantity >= 0 then
											...
											TriggerServerEvent('esx_personalmenu:Weapon_addAmmoToPedS', GetPlayerServerId(closestPlayer), PersonalMenu.ItemSelected.name, quantity)
			...
			RageUI.Button(PersonalMenu.BillData[i].label, nil, {RightLabel = '$' .. ESX.Math.GroupDigits(PersonalMenu.BillData[i].amount)}, true, function(Hovered, Active, Selected)
				if (Selected) then
					ESX.TriggerServerCallback('esx_billing:payBill', function()
						ESX.TriggerServerCallback('esx_personalmenu:Bill_getBills', function(bills)
			...
			if (Selected) then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						TriggerServerEvent('esx_personalmenu:Boss_recruterplayer', GetPlayerServerId(closestPlayer), ESX.PlayerData.job.name, 0)
					end
				else
			...
			if (Selected) then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						TriggerServerEvent('esx_personalmenu:Boss_virerplayer', GetPlayerServerId(closestPlayer))
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
			...
			if (Selected) then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						TriggerServerEvent('esx_personalmenu:Boss_promouvoirplayer', GetPlayerServerId(closestPlayer))
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
			...
			if (Selected) then
				if ESX.PlayerData.job.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						TriggerServerEvent('esx_personalmenu:Boss_destituerplayer', GetPlayerServerId(closestPlayer))
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
			...
			if (Selected) then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						TriggerServerEvent('esx_personalmenu:Boss_recruterplayer2', GetPlayerServerId(closestPlayer), ESX.PlayerData.job2.name, 0)
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
			...
			if (Selected) then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						TriggerServerEvent('esx_personalmenu:Boss_virerplayer2', GetPlayerServerId(closestPlayer))
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
			...
			if (Selected) then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						TriggerServerEvent('esx_personalmenu:Boss_promouvoirplayer2', GetPlayerServerId(closestPlayer))
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
			...
			if (Selected) then
				if ESX.PlayerData.job2.grade_name == 'boss' then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						TriggerServerEvent('esx_personalmenu:Boss_destituerplayer2', GetPlayerServerId(closestPlayer))
					end
				else
					ESX.ShowNotification(_U('missing_rights'))
				end
	...
	while true do
		...
		if IsControlJustReleased(0, Config.Controls.OpenMenu.keyboard) then
			if not RageUI.Visible() then
				ESX.TriggerServerCallback('esx_personalmenu:Admin_getUsergroup', function(plyGroup)
