...
Config.InvoicesCommand = 'rechnungen' -- Command used to open the invoices menu
...
Config.PayAutomaticallyAfterLimit = true -- It serves to enable/disable if we want the invoice to be automatically paid after the FÄLLIG date
...
Config.AllowedSocieties = { -- Allowed societies to open the 'Job Rechnungen' and 'Rechnung erstellen' menus
	'police',
	'ambulance'
}
