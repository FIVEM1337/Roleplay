...
Config.SavePlayer = false -- If you get an error like this set this to false // SCRIPT ERROR: @WeaponAmmo/server.lua:414: attempt to call a nil value (field 'SavePlayer')
----------------------------------------------------------------
