garagecoord = {
    {
        ...
        garage_x = 213.60,
        garage_y = -809.20,
        garage_z = 30.00, -- coordinates for this garage
        spawn_x = 228.00,
        spawn_y = -789.20,
        spawn_z = 30.00,
        heading = 247.40 -- Vehicle spawn location
    },
    {
        garage = "B", --PINK MOTEL
        Type = "car",
