...
function Notification(source, notif_type, message)
    if source and notif_type and message then
        ...
        elseif Config.NotificationType.client == 'dope' then
            if notif_type == 1 then
                TriggerClientEvent('dopeNotify:Alert', source, "", message, 5000, 'success')
            elseif notif_type == 2 then
                TriggerClientEvent('dopeNotify:Alert', source, "", message, 5000, 'info')
            elseif notif_type == 3 then
                TriggerClientEvent('dopeNotify:Alert', source, "", message, 5000, 'error')
            end
