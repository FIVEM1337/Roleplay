...
function closeUI(){
    ...
    xhr.open("POST", "https://timemanager/close", true);                                                                                                                                                                                                                                                                                                                                      
    xhr.send(JSON.stringify({}));
}
function easyTimeChange(values, savesettings){
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://timemanager/change", true);                                                                                                                                                                                                                                                                                                                                      
...
$("#easytime-instant-time").click(() => {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://timemanager/instanttime", true);                                                                                                                                                                                                                                                                                                                                      
...
$("#easytime-instant-weather").click(() => {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://timemanager/instantweather", true);                                                                                                                                                                                                                                                                                                                                      
